...
function edit_calendar() {
    var name = document.getElementById("all_calendar").value
...
function delete_calendar() {
    var name = document.getElementById("all_calendar1").value
...
function add_calendar() {
    ...
    if(priv!=1 || priv!=0){   
        alert("The values of Privacy field can be: 1 or 0 only!")
        return;
    }
    
    
    else {
        var data = { "title": itname, "event_type": eve, "description": desc, "time_begin": tbgn, "time_end": tend, "last_modify": lmod, "privacy":priv}
